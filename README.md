# SRF2017 Conference Web Scraper

**Author: Ming Liu**

## Overview
This web scraper is designed to extract all abstracts and papers from the SRF2017 conference (https://proceedings.jacow.org/srf2017/html/sessi0n.htm). The scraper creates folders organized by Session categories and downloads paper information and multiple file types (presentations, papers, posters) for each session.
...
│   ├── MOXA - Facilities I/
│   │   ├── MOXA01_poster - Title.pdf
│   │   └── ...
├── SRF2017_Complete_Index.json  # Master data index (JSON format)
├── SRF2017_All_Papers.csv      # Complete papers CSV table
├── SRF2017_Final_Report.txt    # Final scraping report
...
```python
# Base URL
base_url = "https://proceedings.jacow.org/srf2017/"

# Output directory
output_dir = "SRF2017_Data"
...
## Log Files
- `srf2017_scraper.log` - Main scraper log
